...
- Home is a right-hand roadside spawn on the eastern limb of Beverly Drive, about **24.4 meters** from the house address point, facing the nearby West Ridge Road exit. The 2025 aerial resolves a driveway-mouth stub, but trees obscure its connection to the house/garage; no complete driveway connection is claimed.
