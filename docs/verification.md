...
- Browser race: real442 GLB loaded and rendered, countdown completed, actual physics driver completed3laps, final visual build results reported6:35.62. Synthetic pad then restarted from lap1/checkpoint1, and Return Home exited the event. See `browser-verification.json` and `browser-race-results.png`.
